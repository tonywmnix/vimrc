...
dirs = "/p/com/eda/synopsys/vcsmx/D-2010.06/etc/rvm"
...
def CreateTagsFile(config, languages, options):
	...
	ctags_cmd = '%s %s %s %s %s' % (ctags_exe, config['CTAGS_OPTIONS'], "--languages=" + ",".join(ctags_languages), " ".join(config['CTAGS_FILES']), " ".join(config['CTAGS_DIRS']))
...
def GetLanguageParameters(lang):
	...
	if lang == 'c':
		...
		params['suffix'] = 'sv'
		params['name'] = 'systemverilog'
		params['extensions'] = 'sv'
	elif lang == 'java':
		params['suffix'] = 'java'
		params['name'] = 'java'
...
def main():
	...
	full_language_list = ['c', 'systemverilog', 'java', 'perl', 'python', 'ruby', 'vhdl', 'php', 'c#']
...
def GetKindList():
	...
	LanguageKinds['systemverilog'] = \
	{
		'ctags_c': 'CTagsIdentifier',
		'ctags_d': 'CTagsIdentifier',
		'ctags_e': 'CTagsIdentifier',
		'ctags_f': 'CTagsIdentifier',
		'ctags_g': 'CTagsIdentifier',
		'ctags_h': 'CTagsIdentifier',
		'ctags_i': 'CTagsIdentifier',
		'ctags_p': 'CTagsIdentifier',
		'ctags_m': 'CTagsIdentifier',
    } 
	LanguageKinds['systemverilog1'] = \
	{
		'ctags_c': 'CTagsClass',
		'ctags_d': 'CTagsDefinedName',
		'ctags_e': 'CTagsEnumerationValue',
