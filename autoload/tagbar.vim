...
function! s:InitTypes()
    ...
    " System Verilog {{{3
    let type_verilog_systemverilog = s:TypeInfo.New()
    let type_verilog_systemverilog.ctagstype = 'verilog_systemverilog'
    let type_verilog_systemverilog.kinds     = [
        \ {'short' : 'c', 'long' : 'class',               'fold' : 1, 'stl' : 1},
        \ {'short' : 'p', 'long' : 'programs',            'fold' : 1, 'stl' : 1},
        \ {'short' : 'i', 'long' : 'interfaces',          'fold' : 1, 'stl' : 1},
        \ {'short' : 'e', 'long' : 'typedefs',            'fold' : 0, 'stl' : 1},
        \ {'short' : 'f', 'long' : 'functions',           'fold' : 0, 'stl' : 1},
        \ {'short' : 'm', 'long' : 'module',              'fold' : 1, 'stl' : 1},
        \ {'short' : 'n', 'long' : 'net data types',      'fold' : 0, 'stl' : 1},
        \ {'short' : 'P', 'long' : 'ports',               'fold' : 0, 'stl' : 1},
        \ {'short' : 'z', 'long' : 'signals',             'fold' : 0, 'stl' : 1},
        \ {'short' : 't', 'long' : 'tasks',               'fold' : 0, 'stl' : 1}
    \ ]
    let type_verilog_systemverilog.sro        = '.'
    let type_verilog_systemverilog.kind2scope = {
        \ 'c' : 'class',
        \ 'm' : 'module',
    \ }
    let type_verilog_systemverilog.scope2kind = {
        \ 'class'    : 'c',
        \ 'module'   : 'm',
    \ }
    let s:known_types.verilog_systemverilog = type_verilog_systemverilog
    " Verilog {{{3
    let type_verilog = s:TypeInfo.New()
    let type_verilog.ctagstype = 'verilog'
    let type_verilog.kinds     = [
        \ {'short' : 'd', 'long' : 'define',              'fold' : 0, 'stl' : 1},
        \ {'short' : 'c', 'long' : 'class',               'fold' : 1, 'stl' : 1},
        \ {'short' : 'p', 'long' : 'programs',            'fold' : 1, 'stl' : 1},
        \ {'short' : 'i', 'long' : 'interfaces',          'fold' : 1, 'stl' : 1},
        \ {'short' : 'e', 'long' : 'typedefs',            'fold' : 0, 'stl' : 1},
        ...
        \ {'short' : 't', 'long' : 'tasks',               'fold' : 0, 'stl' : 1}
    \ ]
    let type_verilog.sro        = '::'
    let type_verilog.kind2scope = {
        \ 'c' : 'class'
    \ }
    let type_verilog.scope2kind = {
        \ 'class'     : 'c'
    \ }
